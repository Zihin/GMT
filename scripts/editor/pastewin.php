...
<html>
<head>
<title><?=$lang['titles']['pastewin']; ?></title>
...
<div class="dialog_content"> 
	<p><?=$lang['paste_word_contents_below']; ?></p>
	<div align="center"> 
		<iframe src="<?=WP_WEB_DIRECTORY.'secure.htm' ?>" id="pasteFrame" class="inset" style="background-color: #ffffff; height:145px; width:98%;" frameborder="0"></iframe>
	</div>
	<div> 
		<input id="remove_style" name="remove_style" type="checkbox" value="" checked="checked">
		<?=$lang['remove_styles']; ?>
	<div align="center"> 
		<input class="button" type="submit" value="<?=$lang['insert']; ?>" name="Insert">
		<input class="button" type="button" value="<?=$lang['cancel']; ?>" name="Cancel" onClick="window.close();">
	</div>
</div></form>
</body>
</html>
