...
<html>
<head>
<title><?=$lang['titles']['smileys']; ?></title>
...
<fieldset>
<legend><?=$lang['emoticon_smilies']; ?></legend>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1" align="center">
	<tr> 
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley1.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['smile']; ?></td>
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley9.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['embarrassed']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley2.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['wink']; ?></td>
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley10.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['star']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley3.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['shocked']; ?></td>
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley11.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['dead']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley4.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['big_smile']; ?></td>
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley12.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['sleepy']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley5.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['confused']; ?></td>
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley13.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['disapprove']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley6.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['unhappy']; ?></td>
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley14.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['approve']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley7.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['angry']; ?></td>
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley15.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['evil_smile']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley8.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['clown']; ?></td>
		<td width="50%" class="text"><img src="<?=WP_WEB_DIRECTORY; ?>images/smileys/smiley16.gif" width="17" height="17" border="0" align="absmiddle" alt=""> 
			<?=$lang['cool']; ?></td>
	</tr>
<?php } ?>
</table></div>
