...
<html>
<head>
<title><?=$lang['titles']['custom']; ?></title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    ...
    <td height="55%"><iframe id="preview" class="previewWindow" security="restricted" frameborder="0" width="100%" height="321" src="<?=WP_WEB_DIRECTORY; ?>blank.php?lang=<?=$lang_include; ?>"></iframe></td>
  </tr>
</table>
<div align="center"><br> 
	<input class="button" type="submit" value="<?=$lang['insert']; ?>">
	&nbsp;
	<input class="button" type="button" value="<?=$lang['cancel']; ?>" onClick="top.window.close();">
</div>
</form>
</body>
</html>