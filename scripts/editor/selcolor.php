...
<html>
<head>
<title><?=$lang['titles']['selcolor']; ?></title>
...
function initiate() {
	if (obj.color_swatches == '') {
		...
		colorTable += '<tr><td height="14" class="colorCell" bgcolor="" colspan="19" align="center"><?=$lang['default']; ?></td></tr></table>';
...
function end() {
	parentWindow.wp_docolor(obj,'<?=stripslashes($_GET['action']); ?>',document.getElementById('selcolor').value)
	window.close();
	return false;
}
	...
	<div id="tab_container"> 
		...
		<div id="web_color_container" style="display:none"> 
			<table id="web_colortable" width="100%" border="0" cellspacing="0" cellpadding="0" class="colortable">
				...
				<tr> 
					<td class="colorCell" bgcolor="" colspan="19" align="center"><?=$lang['default']; ?></td>
				</tr>
			</table>
		</div>
	</div>
