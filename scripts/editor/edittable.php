...
<html>
<head>
<title><?=$lang['titles']['edittable']; ?></title>
...
function open_image_window(action) {
	image_action = action
	szURL= '<?=WP_WEB_DIRECTORY; ?>dialog_frame.php?window=' + parentWindow.wp_directory + obj.imagewindow + "&instance_img_dir="+obj.instance_img_dir+"&lang="+obj.instance_lang; 
	...
	<form id="edit_table_form" name="edit_table_form" style="display:inline" onSubmit="return apply();">
				...
				<tr> 
					<td> 
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="5">
							...
							<tr> 
								<td width="140"><?=$lang['horizontal_alignment']; ?></td>
						...
						<fieldset class="fieldsetLine">
						<legend><?=$lang['borders']; ?></legend>
						<table width="100%" border="0" cellpadding="0" cellspacing="5">
							<tr> 
								<td width="140"><?=$lang['background_color']; ?></td>
							...
							<tr> 
								<td colspan="2"> <table border="0" cellspacing="0" cellpadding="0">
										<tr> 
											<td><?=$lang['background_image']; ?> <input type="text" style="width:225px" name="cellBackground" id="cellBackground" onChange="updateStyle()"></td>
											<td> <script type="text/javascript">
											<!--//
											if (obj.imagewindow == 'image.php') {
												document.write('<button class="chooseImage" type="button" onClick="open_image_window(\'cell\')"><img src="<?=WP_WEB_DIRECTORY; ?>images/choose_image.gif" width="18" height="15" alt=""></button>')
											}
											//-->
											</script> </td>
										</tr>
			...
			<table width="420" border="0" cellpadding="0" cellspacing="3" height="243">
				<tr> 
					<td> 
						<!---Table properties----->
						<fieldset class="fieldsetLine">
						<legend><?=$lang['spacing_and_padding']; ?></legend>
						<table width="100%" border="0" cellpadding="0" cellspacing="5">
							<tr> 
								<td width="20%"><?=$lang['cell_spacing']; ?></td>
								<td width="30%"> <input type="text" name="table_cellspacing" id="table_cellspacing" size="4" onChange="updateStyle()"></td>
								<td width="20%"><?=$lang['cell_padding']; ?></td>
						...
						<fieldset class="fieldsetLine">
						<legend><?=$lang['table_size']; ?></legend>
						<table width="100%" border="0" cellpadding="0" cellspacing="3">
							<tr> 
								<td width="20%"><?=$lang['table_width']; ?> </td>
								<td width="30%"> <input type="text" name="table_width" id="table_width" size="6"> 
								</td>
								<td width="20%"><?=$lang['table_height']; ?> </td>
						...
						<fieldset class="fieldsetLine">
						<legend><?=$lang['alignment']; ?></legend>
						<table width="100%" border="0" cellpadding="0" cellspacing="3">
							<tr> 
								<td width="140"><?=$lang['align_on_page']; ?></td>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="3">
							...
							<tr> 
								...
								<td width="20%"><?=$lang['border_color']; ?></td>
							...
							<tr> 
								<td colspan="4"> <table border="0" cellspacing="0" cellpadding="0">
										<tr> 
											<td><?=$lang['background_image']; ?> <input type="text" style="width:225px" name="tableBackground" id="tableBackground" onChange="updateStyle()"></td>
											<td> <script type="text/javascript">
											<!--//
											if (obj.imagewindow == 'image.php') {
												document.write('<button class="chooseImage" type="button" onClick="open_image_window(\'table\')"><img src="<?=WP_WEB_DIRECTORY; ?>images/choose_image.gif" width="18" height="15" alt=""></button>')
											}
											//-->
											</script></td>
										</tr>
		...
		<div style="position:absolute;top:325; left:5; width:420px; " id="botm"> 
			<table border="0" cellpadding="2" cellspacing="0" height="40" width="420">
					...
					<div id="tbl_background" class="previewWindow" style="background-color:#FFFFFF; overflow:hidden; height: 120px"><table width="100%" height="120" cellpadding="0" cellspacing="0">
							<tr> 
								<td> <table cellspacing="0" cellpadding="3" border="0" height="90">
										...
										<tr> 
											<td width="34%" valign="bottom"><?=$lang['row']; ?></td>
										</tr>
									</table></td>
								<td width="100%" valign="middle"> <table cellspacing="0" cellpadding="3" height="90" width="95%" id="tbl" border="0">
										...
										<tr id="tbl_tr"> 
											<td width="34%">&nbsp;</td>
											<td width="33%" id="tbl_td"><?=$lang['cell']; ?></td>
											<td width="33%">&nbsp;</td>
										</tr>
									</table></td>
							</tr>
				...
				<tr> 
					<td align="center" height="100%" class="text" width="100%"> <button type="submit"><?=$lang['apply']; ?></button>
						&nbsp;&nbsp; <button type="button" onClick="window.close();"><?=$lang['cancel']; ?></button></td>
				</tr>
			</table>
		</div>
	</form>
