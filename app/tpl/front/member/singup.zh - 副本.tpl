                    ...
                    <ul class="candlist">
                        <li><span class="left">Sure Name 姓氏：</span>
                            ...
                            <div class="grp"><input name="item[sure_name]" id="sure_name"
                                                    ...
                                                    placeholder="请填写姓氏大写拼音字母" type="text" id="text_surname" class="text text_surname" <?=$v['is_disabled']?>/>
                        ...
                        <li><span class="left">Given Name 名字：</span>
                            ...
                            <div class="grp"><input name="item[given_name]" id="given_name"
                                                    ...
                                                    placeholder="请填写名字大写拼音字母" type="text"  class="text text_name" <?=$v['is_disabled']?>/>
...
Calendar.setup({
	...
	singleClick    :    true
                        ...
                        <li class="photo cf"><span class="left">Upload ID 上传考生身份证反面：</span>
