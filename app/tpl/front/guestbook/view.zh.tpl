...
<div class="content">
        ...
        <form action="?guestbook,post" method="post" name="form1" id="form1" onsubmit="return chkfiled(this);">
          <tr> </tr>
          <tr align="center"> </tr>
          <tr>
            <td height="13"><div align="center">姓 
              名</div></td>
            <td width="91%" height="13"><input class="text input230" name="item[g_name]" type="text"  id="item[g_name]" size="40" maxlength="20" />
              * 您的真实姓名，请使用中文</td>
          </tr>
          <tr>
            <td><div align="center">电 话</div></td>
            <td width="91%"><input class="text input230"  name="item[g_phone]" type="text"  id="item[g_phone]" size="40" maxlength="20" />
              * 电话是您的重要联系方式，请正确填写 </td>
          </tr>
          <tr>
            <td align="center"> 地 址</td>
            <td width="91%"><input class="text input230"  name="item[g_addr]" type="text"  id="item[g_addr]" size="40" maxlength="50" />
              (可不填)请输入您的联系地址，以保证资料邮递 </td>
          </tr>
          <tr>
            <td align="center">邮 编</td>
            <td width="91%"><input name="item[g_postcode]" type="text"  id="item[g_postcode]" size="40" maxlength="20" class="text input230" />
              (可不填)请输入您的邮政编码 </td>
          </tr>
          <!--  <tr>
          ...
          <tr>
            ...
            <td width="91%"><input class="text input230"  name="item[g_email]"  id="item[g_postcode]"  type="text"  size="40" maxlength="40" />
              (可不填)请正确填写电子信箱,以便给您发送相关资料</td>
          </tr>
          <tr>
            <td><div align="center">留 言</div></td>
            <td width="91%"><textarea  style="width:400px; background-color: #ffffff; border: 1px solid #f8ac98;"  name="item[content]" cols="70" rows="6"   ></textarea>
            </td>
          </tr>
          <tr height="20">
          ...
          <tr>
            ...
            <td width="91%" valign="top">
                <input name="item[g_know][]" type="checkbox" class="d" value="央视" /> 央视&nbsp;
&nbsp;
&nbsp;
              <input  name="item[g_know][]" type="checkbox" class="d"  value="招商平台" /> 招商平台&nbsp;
              <input name="item[g_know][]" type="checkbox" class="d" value="搜狐网" /> 搜狐网 &nbsp;
              <input name="item[g_know][]" type="checkbox" class="d" value="新浪网" /> 新浪网&nbsp;&nbsp;

              <input name="item[g_know][]" type="checkbox" value="其他网站" />
              其他网站<br />
              <input name="item[g_know][]" type="checkbox"  value="百度搜索引擎" />
              百度搜索&nbsp;
              <input name="item[g_know][]" type="checkbox"  value="网络招商平台" />
              网络招商&nbsp;
              <input name="item[g_know][]" type="checkbox"  value="电视" />
              电视 &nbsp;&nbsp;&nbsp; 
              <input name="item[g_know][]" type="checkbox"value="报纸" />
              报纸&nbsp; &nbsp;&nbsp;
              <input name="item[g_know][]" type="checkbox"  value="杂志" />
              杂志</td>
          </tr>
          <tr>
...
function chkfiled(form){
  ...
  var isPostcode=/^[a-zA-Z0-9 ]{3,12}$/; 
   ...
   if(document.getElementById('item[g_name]').value == "") {
	document.getElementById('item[g_name]').focus();
    alert("对不起，请填写姓名！");
	return false;
}
...
if(isTel.test(document.getElementById('item[g_phone]').value)==false) {
	document.getElementById('item[g_phone]').focus();
    alert("对不起，请填写联系电话！");
	return false;
}
