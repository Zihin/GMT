...
<div class="winbox" style="width:480px;margin:0 auto; text-align:left;"> <b class="b1"></b><b class="b2"></b><b class="b3"></b><b class="b4"></b>
    <h1>系统信息</h1>
  <div class="boxcontent" style="font:14px/24px '宋体'; padding:15px 15px 5px 30px;"><img src="imgs/icon/i.gif" />
    <?=$v['msg']?>
  <div align="right" style="padding-top:20px;"><?php if($v['links']) echo "{$v['links']}"; else echo "<a href='{$_SERVER['HTTP_REFERER']}'>返回上一页</a>"?></div></div>
