...
<form id="main_form" name="main_form" action="<?=$v['form_act'];?>" method="post">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="180" valign="top" bgcolor="#a0c6e5" id='left_menu' height='600'><?php echo plugin('admin_menu','友情链接列表');?>
      ...
      <td valign="top"><div class="winbox"> <b class="b1"></b><b class="b2"></b><b class="b3"></b><b class="b4"></b>
        ...
        <div class="boxcontent">
          ...
          <div style="background:url(imgs/sbar_bg.gif); border:1px solid #FCE6AA; padding:5px;margin-bottom:5px; text-align:right;">
            标题关键字:
