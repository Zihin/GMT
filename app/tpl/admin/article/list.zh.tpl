...
<form id="main_form" name="main_form" action="<?=$v['form_act'];?>" method="post">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="180" valign="top" bgcolor="#a0c6e5" id='left_menu' height='600'><?php echo plugin('admin_menu','文章列表');?>
      ...
      <td valign="top"><div class="winbox"> <b class="b1"></b><b class="b2"></b><b class="b3"></b><b class="b4"></b>
        ...
        <div class="boxcontent">
          ...
          <div style="background:url(imgs/sbar_bg.gif); border:1px solid #FCE6AA; padding:5px;margin-bottom:5px; text-align:right;">置顶:
            <?=$v['istop_sel']?>
            类别:
            <?=$v['cate_sel']?>
            标题关键字:
            <input name="kw_title" type="text" id="kw_title" value="<?=$v['kw']['kw_title']?>" size="30" />
            状态:
            <?=$v['state']?>
            <br />
            编辑:
            <input name="kw_editor" type="text" id="kw_editor" value="<?=$v['kw']['kw_editor']?>" size="12" />
            发布时间:
	...
	singleClick    :    true
          ...
          <table id="data" width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF">
                  ...
                  <tfoot>
                    <tr bgcolor="#f0f8fe">
                      <td align="center">↑</td>
                      <td colspan="5" align="center"><?=$v['page_index'] //分页索引?></td>
                    </tr>
                    <tr>
